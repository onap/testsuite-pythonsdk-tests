...
class TestReportsCollection(unittest.TestCase):
    ...
    def test_generate_report_json(self):
        ...
        self.assertEqual(report_dict['usecase'], 'Test Service')
        self.assertEqual(report_dict['details'], 'Test Details')
        self.assertEqual(report_dict['components'], 'Test Components')
