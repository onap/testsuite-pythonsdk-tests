...
class TestReportsCollection(unittest.TestCase):
    ...
    def test_generate_report_json(self):
        ...
        self.assertEqual(report_dict['usecase'], 'test_service_settings')
        self.assertEqual(report_dict['details'], 'Onboarding, distribution and instanitation of an Ubuntu VM using à la carte')
