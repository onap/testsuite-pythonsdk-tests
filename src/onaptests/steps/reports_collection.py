...
class ReportsCollection:
    ...
    def generate_report(self) -> None:
        ...
        jinja_env.get_template('reporting.html.j2').stream(
            ...
            str(Path(settings.REPORTING_FILE_DIRECTORY).joinpath(settings.REPORTING_FILE_PATH)))
        ...
        with open(str(Path(settings.REPORTING_FILE_DIRECTORY).joinpath(settings.JSON_REPORTING_FILE_PATH)), 'w') as f:
