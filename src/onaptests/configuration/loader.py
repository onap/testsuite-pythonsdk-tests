...
SETTINGS_ENV = "ONAP_PYTHONSDK_TEST_SETTINGS"
...
class SettingsLoader:
    ...
    Load global settings and optionally load
        ...
        stored in ONAP_PYTHONSDK_TEST_SETTINGS environment
        variable.
    ...
    def __init__(self) -> None:
        ...
        Raises:
            ValueError: If ONAP_PYTHONSDK_TEST_SETTINGS environment variable
